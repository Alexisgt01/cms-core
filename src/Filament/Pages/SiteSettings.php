            ...
            ->schema([
                Tabs::make('Parametres')
                    ->tabs([
                        ...
                        Tabs\Tab::make('Fonctionnalites')
                            ->icon('heroicon-o-adjustments-horizontal')
                            ->schema([
                                \Filament\Forms\Components\Placeholder::make('features_info')
                                    ->content('Activez ou desactivez les modules visibles dans la sidebar. Un module desactive est masque et inaccessible. Les modifications prennent effet apres sauvegarde et rechargement de la page.')
                                    ->columnSpanFull(),

                                Fieldset::make('Tableaux de bord')
                                    ->schema([
                                        Toggle::make('features.dashboards')
                                            ->label('Tableaux de bord')
                                            ->default(true)
                                            ->live(),
                                        Toggle::make('features.dashboards_blog')
                                            ->label('Dashboard Blog')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.dashboards')),
                                        Toggle::make('features.dashboards_admin')
                                            ->label('Dashboard Administration')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.dashboards')),
                                    ])
                                    ->columns(3),
                                ...
                                Fieldset::make('Blog')
                                    ->schema([
                                        Toggle::make('features.blog')
                                            ->label('Blog')
                                            ->default(true)
                                            ->live(),
                                        Toggle::make('features.blog_authors')
                                            ->label('Auteurs')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.blog')),
                                        Toggle::make('features.blog_categories')
                                            ->label('Categories')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.blog')),
                                        Toggle::make('features.blog_tags')
                                            ->label('Tags')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.blog')),
                                        Toggle::make('features.blog_settings')
                                            ->label('Parametres du blog')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.blog')),
                                    ])
                                    ->columns(3),

                                Fieldset::make('Contenu')
                                    ->schema([
                                        Toggle::make('features.media')
                                            ->label('Medias')
                                            ->default(true),
                                        Toggle::make('features.pages')
                                            ->label('Pages')
                                            ->default(true)
                                            ->live(),
                                        Toggle::make('features.pages_sections')
                                            ->label('Catalogue de sections')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.pages')),
                                        Toggle::make('features.pages_templates')
                                            ->label('Modeles de section')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.pages')),
                                    ])
                                    ->columns(3),
                                ...
                                Fieldset::make('SEO')
                                    ->schema([
                                        Toggle::make('features.seo')
                                            ->label('SEO')
                                            ->default(true)
                                            ->live(),
                                        Toggle::make('features.seo_redirections')
                                            ->label('Redirections')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.seo')),
                                    ])
                                    ->columns(3),

                                Fieldset::make('Collections')
                                    ->schema([
                                        Toggle::make('features.collections')
                                            ->label('Collections')
                                            ->default(true),
                                    ])
                                    ->columns(3),
                                ...
                                Fieldset::make('Contact')
                                    ->schema([
                                        Toggle::make('features.contact')
                                            ->label('Contact')
                                            ->default(true)
                                            ->live(),
                                        Toggle::make('features.contact_contacts')
                                            ->label('Contacts')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.contact')),
                                        Toggle::make('features.contact_requests')
                                            ->label('Demandes')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.contact')),
                                        Toggle::make('features.contact_webhooks')
                                            ->label('Webhooks')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.contact')),
                                        Toggle::make('features.contact_deliveries')
                                            ->label('Deliveries')
                                            ->default(true)
                                            ->visible(fn (\Filament\Forms\Get $get): bool => (bool) $get('features.contact')),
                                        Toggle::make('features.contact_settings')
                                ...
                                Fieldset::make('Administration')
                                    ->schema([
                                        Toggle::make('features.administration_users')
                                            ->label('Utilisateurs')
                                            ->default(true),
                                        Toggle::make('features.administration_roles')
                                            ->label('Roles')
                                            ->default(true),
                                        Toggle::make('features.administration_permissions')
                                            ->label('Permissions')
                                            ->default(true),
                                        Toggle::make('features.administration_site_settings')
                                            ->label('Parametres du site')
                                            ->default(true)
                                            ->helperText('Attention : desactiver ce module vous empeche d\'acceder a cette page.'),
                                        Toggle::make('features.administration_activity_log')
