...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('blog_authors', function (Blueprint $table) {
            $table->string('h1', 255)->nullable()->after('display_name');
            $table->longText('content_seo_top')->nullable()->after('bio');
            ...
            $table->string('og_type', 50)->nullable()->after('meta_description');
