<div
    x-data="{
        mode: 'desktop',
        get title() {
            return $wire.data?.meta_title || $wire.data?.title || $wire.data?.name || $wire.data?.display_name || ''
        },
        get description() {
            return $wire.data?.meta_description || ''
        },
        get slug() {
            return $wire.data?.slug || ''
        },
...
>
    ...
    <div class="mb-3 flex items-center justify-between">
        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Apercu Google</span>
    ...
    <div :class="mode === 'mobile' ? 'max-w-[360px]' : 'max-w-[600px]'" class="space-y-1">
        ...
        <div class="flex items-center gap-1.5 text-sm">
            ...
            <span class="text-gray-600 dark:text-gray-400" x-text="slug || '...'"></span>
        </div>
        ...
        <div
            ...
            x-text="title ? truncate(title, mode === 'mobile' ? 55 : 60) : 'Titre meta...'"
        ></div>
        ...
        <div
            ...
            x-text="description ? truncate(description, mode === 'mobile' ? 120 : 160) : 'Description meta...'"
        ></div>
    </div>
