<div
    x-data="{
        get title() {
            return $wire.data?.og_title_template || $wire.data?.default_meta_title_template || ''
        },
        get description() {
            return $wire.data?.og_description_template || $wire.data?.default_meta_description_template || ''
        },
        get siteName() {
            return $wire.data?.og_site_name || '{{ config('app.name') }}'
        },
        get imageUrl() {
            const img = $wire.data?.og_image_fallback
...
>
    <span class="mb-3 block text-sm font-medium text-gray-700 dark:text-gray-300">Apercu Facebook (image & templates par defaut)</span>
    ...
    <div class="max-w-[524px] overflow-hidden rounded-md border border-gray-300 bg-gray-50 dark:border-gray-600 dark:bg-gray-800">
        ...
        <div class="px-3 py-2.5">
            ...
            <div
                ...
                x-text="title || 'Template titre OG...'"
            ...
            <div
                ...
                x-text="description || 'Template description OG...'"
